<template>
  <div class="datepicker control" :class="[size, { 'is-expanded': expanded }]">
    ...
    >
      ...
      <b-dropdown-item :disabled="disabled" :focusable="focusable" custom>
        <header class="datepicker-header">
          <template v-if="$slots.header !== undefined && $slots.header.length">
            <slot name="header" />
          </template>
          <div v-else class="pagination field is-centered" :class="size">
            <a
        ...
        <div v-if="!isTypeMonth" class="datepicker-content">
          <b-datepicker-table
